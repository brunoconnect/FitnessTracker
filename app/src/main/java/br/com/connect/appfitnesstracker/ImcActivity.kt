...
class ImcActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSend.setOnClickListener {
            ...
            val service = getSystemService(Context.INPUT_METHOD_SERVICE) as InputMethodManager // Metodo que esconde o teclado logo apos abrir o popup
...
//            nao pode inserir / comecar com 0
        if (editWeight.text.toString().isNotEmpty() && editHeight.text.toString()
